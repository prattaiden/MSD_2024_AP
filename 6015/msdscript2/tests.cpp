...
//        CHECK ( (new Mult(new Mult(new Num (2), new Let("x", new Num(5), new Add(new Var("x") , new Num(1)) )), new Num(3)))->interp() == 36);
//        //Variable unchanged exception check
//        CHECK_THROWS_WITH ((new Add(new Let("x", new Num(3), new Let("y", new Num(3), new Add(new Var("y"), new Num(2))) ), new Var("x")))->interp(), "no value for variable");
//        //Let in lhs of add
...
//        //Triple nested let
//        CHECK((new Let("x", new Num(5), new Add(new Let("y", new Num(3), new Let("y", new Num(2), new Add(new Var("y"), new Num(5)))), new Var("x"))))
//                      ->to_string() == "(_let x=5 _in ((_let y=3 _in (_let y=2 _in (y+5)))+x))");
//        //Let nested with let in right hand side
//        CHECK( (new Let("x", new Let("y", new Num(7), new Add(new Var("y"), new Num(6))), new Add(new Var("x"), new Num(3))))
...
//        CHECK ( (new Mult(new Mult(new Num (2), new Let("x", new Num(5), new Add(new Var("x") , new Num(1)) )), new Num(3)))->to_pp_string() == "(2 * _let x = 5\n"
//                                                                                                                                                        "     _in  x + 1) * 3");
//        //Let nested to the left in add expression which is nested to the right within a multiplication expression
//        CHECK((new Mult(new Num(5), new Add(new Let("x", new Num(5), new Var("x")), new Num(1))))->to_pp_string() == "5 * ((_let x = 5\n"
//                                                                                                                             "      _in  x) + 1)");
//        //Let in lhs of add
//        CHECK ( (new Add(new Let("x", new Num(2), new Add(new Var("x"), new Num(9))), new Num(4)))->to_pp_string() == "(_let x = 2\n"
//                                                                                                                              " _in  x + 9) + 4");
//        //Let in lhs of multiplication expression
//        CHECK((new Mult(new Let("x", new Num(5), new Add(new Var("x"), new Num(8))), new Num(3)))->to_pp_string() == "(_let x = 5\n"
//                                                                                                                             " _in  x + 8) * 3");
//        //todo do i need () for the mult??????
//        //Let nest as right argument of un-parenthesized multiplication expression
////        CHECK((new Add (new Mult(new Num(4), new Let("x", new Num(5), new Add(new Var("x"), new Num(1)))), new Num(9)))->to_pp_string() == "4 * (_let x = 5\n"
////                                                                                                                                                   "     _in  x + 1) + 9");
//        //Let nested to the left within let that is nested to the left within add
//        CHECK ((new Add(new Let("x", new Num(3), new Let("y", new Num(3), new Add(new Var("y"), new Num(2))) ), new Var("x")))->to_pp_string() == "(_let x = 3\n"
//                                                                                                                                                                   " _in  _let y = 3\n"
//                                                                                                                                                                   "     _in  y + 2) + x");
