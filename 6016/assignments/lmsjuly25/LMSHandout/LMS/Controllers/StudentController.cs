...
namespace LMS.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        {
            var s_query = from s in db.Submissions
            ...
            else
            {
                ...
                new_s.Assignment = (from a in db.Assignments
                                    where a.Name == asgname && a.CategoryNavigation.Name == category
        ...
        public IActionResult GetGPA(string uid)
        {
            ...
            Hashtable letterToGPA = new Hashtable(){
            ...
            else
            {
                ...
                foreach (string grade in query)
                {
                    ...
                    {
                        cummulativeGPA += (double)letterToGPA[grade];
                        numOfGrades++;
                    }
                    if (cummulativeGPA == 0.0)
                    {
                        currentGPA = cummulativeGPA;
                    }
                    else
                    {
                        // take the cumulative score divided by the total number of grades a student has 
                        currentGPA = cummulativeGPA / numOfGrades;
                    }

                }
                return Json(new { gpa = currentGPA });
            }
