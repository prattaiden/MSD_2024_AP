...
//             var assignemntsFromStudent = (from e in db.Enrolleds where e.Student == uid && e.ClassNavigation.Season == season 
//                 && e.ClassNavigation.Year == year && e.ClassNavigation.ListingNavigation.Number == course_num &&
//                     e.ClassNavigation.ListingNavigation.Department == subject
//                         join assignmentCategories in db.AssignmentCategories on e.Class equals assignmentCategories.InClass
//                             into enrollAssignCat from eac in enrollAssignCat.DefaultIfEmpty() join assignments in db.Assignments 
//                                 on eac.CategoryId equals assignments.Category into assFound from a in assFound
//                                     select new {score = (from s in db.Submissions where s.Student == uid && s.Assignment == a.AssignmentId
//                                         select (int?)s.Score).FirstOrDefault() ?? 0,
//                                                 maxPoints = a.MaxPoints, weight = eac.Weight}).ToList();
...
//             foreach(var points in assignemntsFromStudent){
//                 // maxClassScore = 100;
//                 // studentScore = 90;
//                 maxClassScore += points.maxPoints * (points.weight / 100f);
//                 studentScore += points.score * (points.weight / 100f);
//             }
//             // Get the category weight
//             var catWeightQuery = from e in db.Enrolleds
//                                 where e.Student == uid
...
//             // foreach(var cat in catWeightQuery){
//             //     catWeight += cat;
//             // }
...
//                 grade = "A";
//             }
//             else if(studentFinalScore <= 93 && studentFinalScore > 89){
//                 grade = "A-";
//             }
//             else if(studentFinalScore <= 89 && studentFinalScore > 86){
//                 grade = "B+";
//             }
//             else if (studentFinalScore <= 86 && studentFinalScore > 83){
//                 grade = "B";
//             }
//             else if (studentFinalScore <= 83 && studentFinalScore > 79){
//                 grade = "B-";
//             }
//             else if (studentFinalScore <= 79 && studentFinalScore > 76){
//                 grade = "C+";
//             }
//             else if(studentFinalScore <= 76 && studentFinalScore > 73){
//                 grade = "C";
//             }
//             else if(studentFinalScore <= 73 && studentFinalScore > 69){
//                 grade = "C-";
//             }
//             else if (studentFinalScore <= 69 && studentFinalScore > 66){
//                 grade = "D+";
//             }
//             else if (studentFinalScore <= 66 && studentFinalScore > 63){
//                 grade = "D";
//             }
//             else if(studentFinalScore <= 63 && studentFinalScore > 59){
//                 grade = "D-";
//             }
//             return grade;
//         }
